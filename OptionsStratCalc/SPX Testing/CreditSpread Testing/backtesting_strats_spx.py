...
def PCS_SPX(TradeParameters, StartDate, ScalingMethod):
    """Backtests selling Mon2Wed, Wed2Fri, and Fri2Mon put credit spreads on SPX and resulting gains/losses.
    ...
    for iDate in range(SPXDateOffset, len(SPXHistPrice)-1):
        ...
        if CurrentDay == ExpDate and Position:
            ...
            # Condition 2 - Partial win with SPX closing above breakeven
                ...
                # Calculate the total profit of the trade
                Profit = (Credit - (Strike - SPXC) * 100) * NumberSpreads - TotalFees
                BacktestResults[4] +=1
            ...
            # Calculate the amount of taxes to be paid - factors in reduction from losses
            Taxes = Profit * 0.25
...
def CCS_SPX(TradeParameters, StartDate, ScalingMethod):
    ...
    Backtests selling Mon2Wed, Wed2Fri, and Fri2Mon call credit spreads on SPX and resulting gains/losses.
