...
def PCS_SPX2(TradeParameters, StartDate, ScalingMethod):
    """Has no stop loss - otherwise same as PCS_SPX
...
def PCS_SPX3(TradeParameters, StartDate, ScalingMethod):
    """10 points for Virt - otherwise same as PCS_SPX
    ...
    for iDate in range(SPXDateOffset, len(SPXHistPrice)-1):
        ...
        elif ScalingMethod == "contracts": Width = 2
...
def CCS_SPX3(TradeParameters, StartDate, ScalingMethod):
    """10 points for Virt - otherwise same as PCS_SPX
