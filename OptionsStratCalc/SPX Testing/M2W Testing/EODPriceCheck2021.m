...
clc
%% Data Files
Set1 = SPReader('C:\Users\Erik\Desktop\devMisc\OptionsCalc\MasterData\SPXMinuteData\SANDP-500_200901_210701.csv');
...
title('15 Minutes Before Close (Sept 2020 - July 2021)')
xlim([-20 20])
...
xlabel('Difference in Price')
ylabel('Number of occurance')
title('10 Binutes Before Close (Sept 2020 - July 2021)')
xlim([-20 20])
...
xlabel('Difference to Closing Price')
ylabel('% Chance of Occurance')
title('10 Minutes Before Close (Sept 2020 - July 2021)')
ylim([0, max(PDF10)])
...
xlabel('Difference in Price')
ylabel('Number of occurance')
title('5 Minutes Before Close (Sept 2020 - July 2021)')
xlim([-15 15])
...
xlabel('Difference in Price')
ylabel('Number of occurance')
title('1 Minutes Before Close (Sept 2020 - July 2021)')
xlim([-3 3])
...
xlabel('Difference to Closing Price')
ylabel('% Chance of Occurance')
title('1 Minute Before Close (Sept 2020 - July 2021)')
ylim([0, max(PDF1)])
