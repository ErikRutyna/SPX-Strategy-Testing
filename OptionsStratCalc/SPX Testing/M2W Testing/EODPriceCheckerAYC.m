...
plot([mean(Delta15M) - std(Delta15M), mean(Delta15M) - std(Delta15M)], [0 1], '-.b')
plot([mean(Delta15M) + std(Delta15M), mean(Delta15M) + std(Delta15M)], [0 1], '-.b')
plot([mean(Delta15M) - 2*std(Delta15M), mean(Delta15M) - 2*std(Delta15M)], [0 1], '-.r')
plot([mean(Delta15M) + 2*std(Delta15M), mean(Delta15M) + 2*std(Delta15M)], [0 1], '-.r')
...
plot([mean(Delta10M) - std(Delta10M), mean(Delta10M) - std(Delta10M)], [0 1], '-.b')
plot([mean(Delta10M) + std(Delta10M), mean(Delta10M) + std(Delta10M)], [0 1], '-.b')
plot([mean(Delta10M) - 2*std(Delta10M), mean(Delta10M) - 2*std(Delta10M)], [0 1], '-.r')
plot([mean(Delta10M) + 2*std(Delta10M), mean(Delta10M) + 2*std(Delta10M)], [0 1], '-.r')
xlabel('Difference to Closing Price')
ylabel('% Chance of Occurance')
title('10 Minutes Before Close')
ylim([0, max(PDF10)])
xlim([-18 18])
...
plot([mean(Delta5M) - std(Delta5M), mean(Delta5M) - std(Delta5M)], [0 1], '-.b')
plot([mean(Delta5M) + std(Delta5M), mean(Delta5M) + std(Delta5M)], [0 1], '-.b')
plot([mean(Delta5M) - 2*std(Delta5M), mean(Delta5M) - 2*std(Delta5M)], [0 1], '-.r')
plot([mean(Delta5M) + 2*std(Delta5M), mean(Delta5M) + 2*std(Delta5M)], [0 1], '-.r')
xlabel('Difference to Closing Price')
ylabel('% Chance of Occurance')
title('5 Minutes Before Close')
...
plot([mean(Delta1M) - std(Delta1M), mean(Delta1M) - std(Delta1M)], [0 1], '-.b')
plot([mean(Delta1M) + std(Delta1M), mean(Delta1M) + std(Delta1M)], [0 1], '-.b')
plot([mean(Delta1M) - 2*std(Delta1M), mean(Delta1M) - 2*std(Delta1M)], [0 1], '-.r')
plot([mean(Delta1M) + 2*std(Delta1M), mean(Delta1M) + 2*std(Delta1M)], [0 1], '-.r')
xlabel('Difference to Closing Price')
ylabel('% Chance of Occurance')
title('1 Minute Before Close')
ylim([0, max(PDF1)])
xlim([-2.5 2.5])
